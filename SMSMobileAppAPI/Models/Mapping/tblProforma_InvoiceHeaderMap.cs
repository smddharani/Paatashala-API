...
{
    public class tblProforma_InvoiceHeaderMap : EntityTypeConfiguration<tblProforma_InvoiceHeader>
    {
        public tblProforma_InvoiceHeaderMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("tblProforma_InvoiceHeader");
