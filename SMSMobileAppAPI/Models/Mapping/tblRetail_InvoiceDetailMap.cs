...
{
    public class tblRetail_InvoiceDetailMap : EntityTypeConfiguration<tblRetail_InvoiceDetail>
    {
        public tblRetail_InvoiceDetailMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("tblRetail_InvoiceDetail");
